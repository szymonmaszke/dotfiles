...
to_config="redshift.conf dunst i3 neofetch polybar python rofi scripts surfraw termite compton.conf flake8 greenclip.cfg nvim/settings nvim/init.vim tmux/line oh-my-zsh/custom/aliases.zsh zsh"
